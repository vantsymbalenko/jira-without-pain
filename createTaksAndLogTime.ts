...
import { createTasks, logTasks } from './puppeteerActions'
...
export interface Options {
	...
	getTasksFromGithub: {
		...
		githubRepos: string[]
	} // get commits from github and based on them create tasks
...
async function createTasksAndLogTime(
	...
	const { year, month, logTime, spentHours, randomFill, randomlyCompleteFill, getTasksFromGithub } = proxyOptions

	//get commits from github
	if (getTasksFromGithub) {
	}
